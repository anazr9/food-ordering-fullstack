...
import RestaurantRepository from "../../../../src/restaurant/data/repository/RestaurantRepositoryImpl";
...
describe("RestaurantRepository", () => {
  ...
  beforeEach(async () => {
    ...
    await client.connect(connectStr);
  ...
  describe("findOne", () => {
    ...
    it("should return a promise reject with error message", async () => {
